...
SiteController.get_instance().get_site(url).create_task('gib answers', endpoint='answers', filter=answer_filter,
                                                        sort='creation', order='desc', tagged='python')
SiteController.get_instance().get_site(url).create_task('gib questions', endpoint='questions', filter=question_filter,
